...
export default function Sidebar({isMinized , setIsminmized,isAdmin,setAdmin}) {
      ...
      <nav className={`${style.nav} shadow-sm`}>
        <ul className="list-unstyled ">
          <li>
            ...
            <i className="fas fa-bag-shopping ps-2 me-4"></i>
            ...
            <ul className="list-unstyled">
              ...
              <li>
                <NavLink to="/layout/cates">
                  <i className="fas fa-qrcode me-4"></i>
        ...
        <div className={`${style.change} shadow pointer`} onClick ={()=>
          ...
          <i className={isMinized ?`fa-solid fa-chevron-right `:`fa-solid fa-chevron-left `}></i>
        </div>
      </nav>
    </>
  );
